...
//            echo '<pre>';
//            print_r($data['cart_product_price']);
//            exit;
            $i = 0;
...
//            print_r($data['discount']['discount_price']);exit;
//            print_r($data['total']);exit;
//            $data['countries'] = $this->user_address->getCountries();
...
//        echo '<pre>';
//        print_r($this->session->grand_total);
//        exit;
        $this->load->view('header');
        $this->load->view('paypal/demos/express_checkout/index', $data);
...
//                print_r($PayPalResult);exit;
        ...
        if (!$this->paypal_pro->APICallSuccessful($PayPalResult['ACK'])) {
            ...
            $coupon_used['user_id'] = $this->session->id;
...
//        exit;
        ...
        $this->email->from('kiran.naik@neosofttech.com');
