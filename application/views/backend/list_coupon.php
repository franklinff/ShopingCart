<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <ol class="breadcrumb">
            <li>
            <h4><a href="<?php echo base_url(); ?>Coupon/addCoupon">Add Coupon</a></h4></li>
        </ol>
                            ...
                            <table class="table table-bordered table-striped" id="dataOne">
                                ...
                                <?php   foreach($current_coupon as $row) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"> 
                                                <div class="buttons">
                                                    <a href="<?php echo base_url(); ?>Coupon/editCoupon/<?php echo $row['id']; ?>">
                                                        <button class="btn btn_delete">Edit</button>
                                                    </a>
                                                    <a href="<?php  echo base_url(); ?>Coupon/deleteCoupon/<?php echo $row['id']; ?>">
