<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <ol class="breadcrumb">
            <li>
            <h4><a href="<?php echo base_url(); ?>Category/addCategory">Add category</a></h4></li>
        </ol>
                               ...
                               <?php   foreach($categories as $row) {
                                   ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="buttons">
                                                    <a href="<?php echo base_url(); ?>Category/deleteCategory/<?php echo $row['id']; ?>">
                                                        <button class="btn btn_edit" id="btn_edit" value="">Delete</button>
                                                    </a>

                                                    <a href="<?php echo base_url(); ?>Category/editCategy/<?php echo $row['id']; ?>">
