          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <form action="add_coupon" method="post" id="add_coupon" >
                ...
                <div class="col-xl-12">
                    <input name="percent_off" id="percent_off" placeholder="Percent off" type="text" class="form-control" >
                </div></br>
    
                <label>Number of uses</label>
                <div class="col-xl-12">
                <input name="no_of_uses" id="no_of_uses" placeholder="Quantity" type="text" class="form-control" >
                </div></br>
