                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <?php if (isset($category['sub_categories'])) { ?>
                                                <a href="<?php echo base_url(); ?>shop/?category_id=<?php echo $category['id']; ?>"><?php echo $category['name']; ?></a>
                                                ...
                                                <ul>
                                                    <?php foreach ($category['sub_categories'] as $sub_category) {
                                                        ...
                                                        <li><a class="<?php
                                                            ...
                                                            ?>" href="<?php echo base_url(); ?>shop/?category_id=<?php echo $sub_category['id']; ?>" name="category_id" ><?php echo $sub_category['name']; ?> </a></li>
                                                        <?php } ?>
                                                </ul>
                                            </div>
                                        </div>
